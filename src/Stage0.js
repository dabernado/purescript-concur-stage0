...
function reconcile(parent, renderedValues, data, createFn, noOp = noOpUpdate, beforeNode, afterNode) {
    // Fast path for clear
    if (data.length === 0) {
...
exports._reconcile = (parent, renderedValues, newValues, compile) => reconcile(parent, renderedValues, newValues, compile)
exports._h = h
